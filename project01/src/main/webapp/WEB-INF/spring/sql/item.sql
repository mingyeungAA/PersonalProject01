...
INSERT INTO ITEM
VALUES(ITEM_NO_SEQ.NEXTVAL, 1, 10, '토핑 라운드 니트');
INSERT INTO ITEM_GROUP
VALUES(ITEM_GROUP_NO_SEQ.NEXTVAL, 1, '아이보리','F','29000',99,
	'20501eb6569c0202686773fa0eb2877b.webp', '하나쯤은 꼭 소장해야 하는 오랫동안 꾸준히 착용 가능한 라운드니트', SYSDATE);
INSERT INTO ITEM
VALUES(ITEM_NO_SEQ.NEXTVAL, 2, 13, '모어 슬림 롱부츠컷 슬랙스 sl(가을,겨율용)');
INSERT INTO ITEM_GROUP
VALUES(ITEM_GROUP_NO_SEQ.NEXTVAL, 2, '베이지','S','39900',99,
